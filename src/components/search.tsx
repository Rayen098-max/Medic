...
export function Search({
  ...
  return (
    <Button
      ...
      variant='outline'
      className={cn(
        'group relative h-8 w-full flex-1 justify-start rounded-md bg-[#0a0f1c] border border-white/10 text-sm font-normal text-muted-foreground shadow-none hover:bg-black/20 sm:w-40 sm:pe-12 md:flex-none lg:w-52 xl:w-64',
        className
      )}
